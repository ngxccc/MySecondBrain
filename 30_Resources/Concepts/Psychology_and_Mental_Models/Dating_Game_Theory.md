...
```mermaid
graph TD
    A[Dating Market Players] --> B[Evolutionary Biology Strategy]
    A --> C[Nash Equilibrium Strategy]
    A --> D[Real-World Status Game Strategy]

    B --> B1[Male: Maximize Mating / Low Cost]
    B --> B2[Female: Cautious / 9mo Pregnancy & 18yr Rearing]

    C --> C1[Cooperative Matching: 5-5, 4-4, 3-3, 2-2, 1-1]
    C --> C2[Optimal Population & Stable Reproduction]

    D --> D1[Females pursue Top Tier Status / Hypergamy]
    D --> D2[Average/Lower Males drop out / Incels]
    D --> D3[Biological Suicidal Loop / Fertility Collapse]
```
