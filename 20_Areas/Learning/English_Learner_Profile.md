...
2. **Prepositions & Verb Complement Patterns**:
   - `be responsible for + V-ing / N`, `have an obligation to + V-bare`, `rather than + V-ing`.
3. **Natural Technical Phrasing**:
   - Chuyển đổi văn phong hỏi/trả lời từ dịch thô từ tiếng Việt sang các cụm từ chuẩn bản ngữ trong làm việc và tài liệu kỹ thuật.
